    ...
    return (
        ...
        <div className="bg-[#24140B] w-3/5 h-screen text-[#CDC8C8] flex flex-col items-center justify-center">
            ...
            <form className="w-1/2">
                ...
                <button type="submit" className="bg-[#946631] my-2 rounded-xl font-bold justify-center w-1/2 flex p-2 hover:scale-95 hover:text-white">{props.buttonText}</button>
                {props.type === "login" && (
                <Link to="/cadastrar"><button  className="bg-[#946631] my-2 rounded-xl font-bold justify-center w-1/2 flex p-2 hover:scale-95 hover:text-white">Quero cadastrar</button></Link>
                )}
            </form>
        </div>
        </>
